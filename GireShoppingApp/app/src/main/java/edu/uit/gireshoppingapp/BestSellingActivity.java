...
public class BestSellingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.best_selling_recview);
        mbase = FirebaseDatabase.getInstance().getReference("best_selling_items");
        ...
        back_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(BestSellingActivity.this, MainActivity.class);
